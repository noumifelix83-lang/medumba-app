            ...
            child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
              ...
              Row(children: [
                ...
                Expanded(child: _ResourceCard(
                  ...
                  titleFr: 'CEPOM',
                  titleEn: 'CEPOM',
                  subtitleFr: 'Certification & partenariat',
                  subtitleEn: 'Certification & partnership',
                  color: const Color(0xFFB45309),
                  isFr: isFr,
                  onTap: () => context.push('/lesson/cepom'),
                )),
              ]),
              const SizedBox(height: 10),
              Row(children: [
                Expanded(child: _ResourceCard(
                  ...
                  titleFr: 'Contact & FAQ',
                  titleEn: 'Contact & FAQ',
                  subtitleFr: 'Questions fréquentes',
                  subtitleEn: 'Frequently asked questions',
                  color: const Color(0xFF0056D2),
                  isFr: isFr,
                  onTap: () => context.push('/lesson/contact'),
                )),
                const SizedBox(width: 10),
